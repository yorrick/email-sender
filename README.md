...
[![Build Status](https://travis-ci.org/yorrick/email-sender.svg?branch=17-confirmation-sms)](https://travis-ci.org/yorrick/email-sender)
[![Coverage Status](https://coveralls.io/repos/yorrick/email-sender/badge.png?branch=17-confirmation-sms)](https://coveralls.io/r/yorrick/email-sender?branch=17-confirmation-sms)
